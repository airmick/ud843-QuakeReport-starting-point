    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < featuresJsonArray.length(); i++) {
                ...
                JSONObject propertiesJsonObject = featureObject.getJSONObject("properties");

                // Extract the value for key called "mag"
                double magnitude = propertiesJsonObject.getDouble("mag");
                // Extract he value for key called "place"
                ...
                Earthquake earthquakeObject = new Earthquake(magnitude, location, time, url);
